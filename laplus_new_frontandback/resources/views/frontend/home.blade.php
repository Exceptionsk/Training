    ...
    <div class="row">
        <div class="col-md-5 col-md-offset-3 login-left">
            <div class="border">
                ...
                <!-- Starting Form -->
                {!! Form::open(array('url' => 'frontend/login'))!!}
                ...
                <div class="row" style="text-align: center">
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-default fill_color btn-lg" name="login">LOG IN</button>
                    </div>
                    <div class="col-md-6">
                        <a class="btn btn-default fill_color btn-lg" href="{{ url('/frontend/user/create') }}">REGISTER</a>
